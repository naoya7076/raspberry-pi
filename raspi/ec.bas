...
'                Stop            ' 受信バッファのクリアに失敗しました．
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "受信バッファエラー"
                End             ' プログラムを終了します．
...
'                Stop            ' 指定されたポート番号は許容範囲にありません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポート№エラー"
                End             ' プログラムを終了します．
 ...
 '                   Stop            ' 指定されたポート番号を開けませんでした
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポート接続がありません"
                   End             ' プログラムを終了します．
...
'                    Stop            ' ポートの標準設定が出来ませんでした
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポート接続ができません"
                    End             ' プログラムを終了します．
...
'                    Stop            ' 指定されたポート番号のクローズに失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートクローズエラー"
                    End             ' プログラムを終了します．
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー１"
                End             ' プログラムを終了します．
...
'                Stop            ' 現在設定値(DCB)の読み込みに失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー2"
                End             ' プログラムを終了します．
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー3"
                End             ' プログラムを終了します．
...
'                Stop            ' 現在設定値(DCB)の読み込みに失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー4"
                End             ' プログラムを終了します．
...
'                Stop            ' 設定文字列の解析に失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー5"
                End             ' プログラムを終了します．
...
'                Stop            ' 現在設定値(DCB)の書き込みに失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー6"
                End             ' プログラムを終了します．
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー7"
                End             ' プログラムを終了します．
...
'                Stop            ' 現在設定値(DCB)の読み込みに失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー8"
                End             ' プログラムを終了します．
...
'                Stop            ' 現在設定値(DCB)の読み込みに失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー9"
                End             ' プログラムを終了します．
...
'                Stop            ' ハンドシェークを書き込めませんでした
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー10"
                End             ' プログラムを終了します．
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー11"
                End             ' プログラムを終了します．
...
'                Stop            ' 受信バッファのデータバイト数の読み取りに失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー12"
                End             ' プログラムを終了します．
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー13"
                End             ' プログラムを終了します．
...
'                Stop            ' バッファの値が少なすぎます．
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー14"
                End             ' プログラムを終了します．
...
'                Stop            ' 受信バッファサイズの読み取りに失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー15"
                End             ' プログラムを終了します．
...
'                    Stop            ' ポートの最大バッファサイズを越えた設定をしようとしました．
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー16"
                    End             ' プログラムを終了します．
...
'                Stop            ' 受信バッファサイズの書き込みに失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー17"
                End             ' プログラムを終了します．
...
'                Stop            ' 現在設定値(DCB)の読み込みに失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー18"
                End             ' プログラムを終了します．
...
'                Stop            ' 現在設定値(DCB)の書き込みに失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー19"
                End             ' プログラムを終了します．
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー20"
                End             ' プログラムを終了します．
...
'                Stop            ' 送信バッファの設定値が小さすぎます
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー21"
                End             ' プログラムを終了します．
...
'                Stop            ' 送信バッファサイズの読み取りに失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー22"
                End             ' プログラムを終了します．
...
'                    Stop            ' ポートの最大バッファサイズを越えた設定をしようとしました．
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー23"
                    End             ' プログラムを終了します．
...
'                Stop            ' 送信バッファサイズの書き込みに失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー24"
               End             ' プログラムを終了します．
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー25"
               End             ' プログラムを終了します．
...
'                Stop            ' 受信バッファの状態を取得できませんでした
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー26"
                End             ' プログラムを終了します．
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー27"
                End             ' プログラムを終了します．
...
'                Stop            ' 文字列送信に失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー28"
                End             ' プログラムを終了します．
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー29"
                End             ' プログラムを終了します．
...
'                        Stop            ' 受信バッファの状態を取得できませんでした
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー30"
                        End             ' プログラムを終了します．
...
'                    Stop            ' 文字列受信に失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー32"
                    End             ' プログラムを終了します．
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー33"
                End             ' プログラムを終了します．
...
'                Stop            ' 文字列送信に失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー34"
                End             ' プログラムを終了します．
...
'                Stop            ' ポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー35"
                End             ' プログラムを終了します．
...
'                        Stop            ' 引数の値が0～255の範囲にありません．
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー36"
                        End             ' プログラムを終了します．
...
'                        Stop            ' 引数の値が整数ではありません．
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー37"
                        End             ' プログラムを終了します．
...
'                            Stop            ' 引数の値が0～255の範囲にありません．
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー38"
                            End             ' プログラムを終了します．
...
'                            Stop            ' 引数の値が整数ではありません．
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー39"
                            End             ' プログラムを終了します．
...
'                    Stop            ' 指定された型には対応していません．
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー40"
                    End             ' プログラムを終了します．
...
'                Stop            ' バイナリーデータの送信に失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー41"
                End             ' プログラムを終了します．
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー42"
                End             ' プログラムを終了します．
...
'                Stop            ' 受信バッファの状態を取得できませんでした
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー43"
                End             ' プログラムを終了します．
...
'                Stop            ' バイナリーデータの受信に失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー44"
                End             ' プログラムを終了します．
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー45"
                End             ' プログラムを終了します．
...
'                Stop            ' CTSの状態が読み取れませんでした
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー46"
                End             ' プログラムを終了します．
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー47"
                End             ' プログラムを終了します．
...
'                Stop            ' RTSの設定に失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー48"
                End             ' プログラムを終了します．
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー49"
                End             ' プログラムを終了します．
...
'                Stop            ' DSRの状態が読み取れませんでした
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー50"
                End             ' プログラムを終了します．
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー51"
                End             ' プログラムを終了します．
...
'                Stop            ' DTRの設定に失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー52"
                End             ' プログラムを終了します．
...
'                Stop        ' 対象となるポート番号が指定されていません
    Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー53"
 End
            Case Is = 1 '-----トラップ可能エラー
                Err.Raise _
                    Number:=10248, _
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー54"
                End             ' プログラムを終了します．
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー55"
                End             ' プログラムを終了します．
...
'                    Stop            ' Breakの送信に失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー56"
                End             ' プログラムを終了します．
...
'                    Stop            ' Break送信の停止に失敗しました
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー57"
                    End             ' プログラムを終了します．
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー58"
                End             ' プログラムを終了します．
...
'                Stop            ' RIの状態が読み取れませんでした
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー59"
                End             ' プログラムを終了します．
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー60"
                End             ' プログラムを終了します．
...
'                Stop            ' DCDの状態が読み取れませんでした
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー61"
                End             ' プログラムを終了します．
...
'                Stop            ' 対象となるポート番号が指定されていません
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー62"
                End             ' プログラムを終了します．
...
'                Stop            ' ポートの情報を取得できませんでした
     Range("I1").Select
     ActiveCell.FormulaR1C1 = "ポートエラー63"
                End             ' プログラムを終了します．
